...
const plans = [
  ...
  },
  {
    ...
    features: [
      ...
      'Slack bot integration (@Verdix)',
      'Advanced PII masking included',
    ],
  },
  {
    id: 'enterprise',
    ...
    features: [
      ...
      'Salesforce CPQ & DocuSign connectors',
      'Cloud data warehouse sync (Snowflake)',
