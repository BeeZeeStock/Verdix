...
export default function SetupPage() {
  ...
  const step5Done = false  // CRM — always optional for now
  ...
  return (
    <div className="p-4 md:p-8 max-w-xl">
      ...
      <div className="mb-8">
        ...
        <p className="text-stone text-sm">
          {allDone
            ...
            : `${doneCount} of ${totalSteps} steps complete — takes about 10 minutes.`}
        </p>
      ...
      <div className="flex flex-col gap-3 mb-6">
        ...
        {/* Step 4 — Connect a billing platform */}
        <StepShell
          n={4}
        ...
        >
          <p className="text-sm text-stone mb-4">
            Connect your Stripe or Chargebee account so Verdix can push approved contracts directly
            as subscriptions — no manual data entry. Without this, billing push is disabled and
            you can only download a CSV.
          </p>
          <div className="flex flex-col gap-3">
            <div className="rounded-xl border border-forest/10 p-4 flex items-center justify-between gap-4 bg-white">
              <div>
                <p className="text-sm font-medium text-ink">Stripe</p>
                <p className="text-xs text-stone mt-0.5">Secret key + publishable key from your Stripe dashboard.</p>
              </div>
              {step4Done ? (
                <span className="text-xs font-semibold text-forest">Connected ✓</span>
              ) : (
                <Link href="/settings/integrations" className={btnPrimary + ' text-xs px-4 py-2 inline-flex'}>
                  Connect
                </Link>
              )}
            </div>
            <div className="rounded-xl border border-forest/10 p-4 flex items-center justify-between gap-4 bg-white">
              <div>
                <p className="text-sm font-medium text-ink">Chargebee</p>
                <p className="text-xs text-stone mt-0.5">Site name + API key from your Chargebee account.</p>
              </div>
              {step4Done ? (
                <span className="text-xs font-semibold text-forest">Connected ✓</span>
              ) : (
          ...
          <Link href="/settings/integrations" className="inline-flex items-center gap-1 text-xs text-forest hover:underline mt-3">
        ...
        >
          <p className="text-sm text-stone mb-4">
            Connect HubSpot or Salesforce and Verdix will automatically create a job whenever a deal
            is marked Closed Won — the contract and customer details are pre-filled from the CRM record.
          </p>
          <div className="rounded-xl border border-forest/10 p-4 bg-white">
            <div className="flex items-center gap-2 mb-1">
              <i className="ti ti-clock text-stone/60" style={{ fontSize: 14 }} />
              <p className="text-sm font-medium text-stone">HubSpot &amp; Salesforce — coming in Phase 2</p>
            </div>
            <p className="text-xs text-stone">
              CRM connectors are under development. Head to Integrations to register interest and
