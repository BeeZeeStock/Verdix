    ...
    (
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 22 }}>
          ...
          <span style={{ fontSize: 44, fontWeight: 600, color: '#1A3D2B', letterSpacing: '-0.01em' }}>Verdix</span>
        </div>
        <div style={{ display: 'flex', marginTop: 44, fontSize: 52, fontWeight: 500, color: '#1C1917', lineHeight: 1.25, maxWidth: 960 }}>
          Your contracts already say what to bill.
        </div>
        <div style={{ display: 'flex', fontSize: 52, fontWeight: 500, color: '#4A7C59', lineHeight: 1.25 }}>
          Your billing system doesn&apos;t know it.
        </div>
        <div style={{ display: 'flex', marginTop: 32, fontSize: 28, color: '#6B6660' }}>
