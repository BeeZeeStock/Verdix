...
- additional_recurring_fees: array of secondary recurring fee components that exist alongside base_monthly_fee. Each entry: { "fee_label": "<name>", "amount": <number>, "description": "<brief note or null>", "billing_frequency": "<cadence or null>", "metric_name": "<string or null>", "rate_per_unit": <number or null>, "required_operational_inputs": <array of strings or null>, "unresolved_kind": "unsupported_semantics" | null, "source_clause": "<verbatim or paraphrased, or null>" }. Use this when the contract explicitly lists multiple SEPARATE recurring line items with distinct names and amounts.
